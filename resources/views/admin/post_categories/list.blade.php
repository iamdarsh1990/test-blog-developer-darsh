...
@section('content')
    ...
    <section>
        ...
        <div class="container-fluid text-right" style="margin-bottom: 16px;">
            <a class="btn btn-success" href="{{url('/posts-categories/create')}}">
                Add New
            </a>
        </div>
        <table class="table">
            ...
            @foreach($list as $post_category)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{url('posts/delete')}}" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal{{$post_category->id}}">
